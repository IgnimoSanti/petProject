...
>(({ className, ...props }, ref) => (
      ...
      `peer inline-flex h-6 w-11 shrink-0 cursor-pointer
       items-center rounded-full border-2 border-transparent
        ...
        focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2
         ...
         dark:focus-visible:ring-slate-300 dark:focus-visible:ring-offset-slate-950 dark:data-[state=checked]:bg-blue-600
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full bg-white shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0 dark:bg-slate-800"
      )}
    />
  </SwitchPrimitives.Root>
))
